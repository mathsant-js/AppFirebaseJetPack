...
fun TelaLogin(
    ...
    Column (
        ...
        Text(text = "Login", color = Color.Cyan, fontSize = 32.sp)
        ...
        TextButton(onClick = {
            navController.navigate(Routes.TelaCadastro)
        }) {
            Text(text = "Você não tem uma conta? Cadastre-se", color = Color.Cyan)
        }
    }
}